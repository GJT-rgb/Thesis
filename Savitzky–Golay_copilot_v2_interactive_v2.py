...
# LOAD DATA
# ---------------------------------------
df = pd.read_csv(r"E:\EMBL\Master EMBL\Python\integrated_true_intensity_vs_separation_enhanced.csv")

x = df["separation_um"].values
y = df["Iint_W_per_m"].values
...
f_low = 0.01    # <<< choose your lower bound
f_high = 0.0139    # <<< choose your upper bound
